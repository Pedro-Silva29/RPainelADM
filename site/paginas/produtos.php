...
<div class="container">
            <div class="card-columns">
                ...
                <div class="card">
                    <img class="card-img-top" src="../assets/img/map.jpg" alt="Imagem de capa do card">
                    <div class="card-body">0p
                ...
                <div class="card">
                    <img class="card-img" src="../assets/img/map.jpg" alt="Imagem do card">
                </div>
